...
type Props = {
  ...
  readonly groupBy:       TreeGroupBy
  readonly selectedNode:  string | null
  readonly expanded:      boolean
  readonly onToggle:      () => void
  readonly onNodeSelect:  (key: string | null) => void
          ...
          <>
            ...
            <div className='tree-groupby-tabs'>
              <button
                ...
                onClick={e => {
                  e.stopPropagation(); onGroupChange('artist')
                }}
              >
                ♪
              </button>
              ...
              <button
                ...
                onClick={e => {
                  e.stopPropagation(); onGroupChange('album')
                }}
              >
                ◼
              </button>
              ...
              <button
                ...
                onClick={e => {
                  e.stopPropagation(); onGroupChange('folder')
                }}
              >
                ⊞
              </button>
